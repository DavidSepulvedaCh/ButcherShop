...
public class BuyResPrint {
    ...
    public void printProducts() {
        try {
            ...
            String archivoPDF = ruta + "/OneDrive/Escritorio/compra_animales.pdf";
            ...
            chunk.append("COMPRA DE ANIMALES\n");
            header.add(chunk);

            productsList.add(header);

            PdfPTable tableProducts = new PdfPTable(5); // Cambio: 5 columnas
            float[] columnWidths = {1f, 1f, 1f, 1f, 1f}; // Cambio: anchos relativos
            ...
            cell = new PdfPCell(new Phrase("Peso @", headerFont));
            cell.setBorderColor(BaseColor.LIGHT_GRAY);
            cell.setBackgroundColor(BaseColor.GRAY);
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setPadding(5f);
            ...
            try {
                ...
                consulta = conBD.prepareStatement("SELECT * FROM compra_animal");
